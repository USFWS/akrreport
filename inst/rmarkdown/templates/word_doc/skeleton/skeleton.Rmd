...
How to cite this report: *Replace this with your citation:* {Anastasio, T., J. Fishman, M. Gordon, P. McConnell. Year. Report title. Refuge Name. City, Alaska. Alaska Refuges Report Series no. YYYY-REPORT#. <https://doi.org/%7BUNIQUE> DOI}
...
```{r bear-fig, fig.cap = "Here's a picture of a bear in Alaska."}
...
If you are using the reference manager [Zotero](https://www.zotero.org/) (**highly recommended**), then Rstudio can [access your reference library directly](https://bookdown.org/pdr_higgins/rmrwr/adding-citations-to-your-rmarkdown.html). Zotero is available through FWS Apps-2-Go. 
