...
By default *akrreport::word_doc* uses a 'akrreport-template.docx' template file, which is based on standard template file for the Alaska Refuge Report Series except for the font type, which is by default 'Helvetica'.
