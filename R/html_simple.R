...
html_simple <- function(
    ...
    mathjax = "akrreport", pandoc_args = NULL, ... ) {
...
##### This was also adjusted to link to the akrreport file names:
# html_simple css and js
html_dependency_simple <- function() {
  htmltools::htmlDependency(name = "html_simple",
                            version = utils::packageVersion("akrreport"),
                            src = system.file("templates/html_simple", package = "akrreport"),
