...
copy_font_files <- function(template, 
                            font, 
                            type = "rmarkdown", 
                            current_dir = ".") {
  ...
  file_copy <- function(template, 
    ...
    file.copy(from = find_resource(template, file = file.path("fonts", font, input), type),
...
rmd_pdf_book_format <- function(..., 
                                template, 
                                filename, 
                                csl) {
  # base format
  fmt <- bookdown::pdf_book(..., 
                            template = find_file(template = template,
                                                      file = filename,
                                                      type = "rmarkdown"))
  fmt$inherits <- "pdf_book"
...
rmd_word_document_format <- function(format, 
                                     filename, 
                                     ...) {
